  ...
  return (
    <AppShell title="Folders">
      <div className="flex h-[calc(100vh-8rem)] gap-4">
            ...
            <Dialog open={createOpen} onOpenChange={setCreateOpen}>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    {createParentId ? "Create a subfolder under the selected folder." : "Create a new folder for organizing documents."}
                  </DialogDescription>
                </DialogHeader>
            ...
            <div className="flex items-center gap-2">
              ...
              {selected && (
                <>
                  ...
                  <Button variant="outline" size="sm" onClick={() => setMoveTargetFolderId(selected)} disabled={selectedDocIds.size === 0}>
        ...
        {/* Move to folder dialog: pick target folder from tree */}
...
function FolderDocRow({
  ...
  return (
    <div
      className={`flex items-center gap-3 rounded-md border px-3 py-2 transition-colors hover:bg-muted/50 ${selected ? "bg-muted/50" : ""}`}
...
function FolderPickItem({
  ...
  return (
    <div>
      <div
        className="flex items-center gap-1 rounded py-1"
